...
load(fullfile(dpath,'\DAQdata.mat')); % load behavior and dff
downsamp(:,1)=knnsearch(DAQdata2.system_time,CAM0.ms); % uc1=unique(downsamp(:,1));
fname=dir('*.csv'); 

PupilFileName= fullfile(dpath,fname.name);
PupilTable=csvread(PupilFileName,3,1);
PupilFileName='Z:\mrsic_flogel\public\projects\SaEl_20220201_VIP\2pdata\vipsilencing\se010\E\labview_data\10EDLC_resnet50_pupiltrackingNov30shuffle1_500000.csv'
